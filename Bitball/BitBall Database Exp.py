...
P6 = Player("Neuvo Urriciani",True,"olympus_omegas")
P7 = Player("Igor Rendón",False,"olympus_omegas")
P8 = Player("Jonatan Towner",False,"olympus_omegas")
P9 = Player("Sofia Mertens",False,"olympus_omegas")
P10 = Player("Diamond Cabbagestalk",False,"olympus_omegas")
...
#Unpacks first and last tuple in "Ordered" list       
        ...
        def penalty():
                ...
                if player1.name in TeamA:
                        ...
                        time.sleep(2)
                        print (player1.name,"takes aim and fires the ball.")
                        time.sleep(2)
                        print ("The ",Team2.name," keeper braces")
                        time.sleep(3)
                        roll = dice_roll(20)
                        kroll = dice_roll(20)
                        if KeeperB.GK+kroll > player1.MAG+roll:
                ...
                if player1.name in TeamB:
                        ...
                        roll = dice_roll(20)
                        kroll = dice_roll(20)
                        if KeeperA.GK+kroll > player1.MAG+roll:
